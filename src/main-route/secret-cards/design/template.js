...
module.exports = yo`
<section class="card-container design-card is-hidden bord">
  <div class="close-btn-container bord">
    <div class="f-line"></div>
    <div class="s-line"></div>
  </div>
  <div class="title-size bord">
    <h1 class="text-title blue">diseño gráfico</h1>
  </div>
  <p class="black body-size bord">
